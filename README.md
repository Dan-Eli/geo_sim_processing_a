...
## Correction
The Chordal Axis algorithm gives a very good approximation of the true medial axis of a polygon but it produces unwanted artifacts it produced the skeleton specially in the case of long and narrow polygon (figure 5) . The main artifacts are: firstly, meaningless small centre line (figure 4a); secondly wrongly formed "T junction" (figure 4c) and "X junction" (crossing junction) (figure 4e).  When the parameter correction is used (_-c_ or _--correction_), the skeleton will prune the meaningless small centre line (4b); it will correct "T junction" and rectify the normal direction of the line (figure 4d); and, it will rectify the "X crossing" by merging two T junction that are adjacent (figure 4f).
